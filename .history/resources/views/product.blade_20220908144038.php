                                            ...
                                            <div class="bg-white px-4 py-5 sm:p-6">
                                              <div class="grid grid-cols-6 gap-6">
                                                ...
                                                <div class="col-span-6">
                                                  <label for="sale_price" class="block text-sm font-medium text-gray-700">Sale sale_pricerice</label>
                                                  <input type="text" name="sale_price" id="sale_price" autocomplete="street-address" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                                </div>
